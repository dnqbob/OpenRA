...
{
	public class KKNDLaserRenderable : IRenderable, IFinalizedRenderable
	{
		...
		{
			var cachedWVec = vec;
			return new KKNDLaserRenderable(offsets.Select(offset => offset + cachedWVec).ToArray(), zOffset, width, color);
		}
